...
export default function ModalAddScheduleBox (props : any) {
  ...
  const [sort, setSort] = useState(isAddOrRevise === 'revise' ? locationData.sort :'가이드투어');
  ...
  const registerPost = async () => {
    ...
    axios
      .post(`${MainURL}/tourschedulebox/registerlocation`, formData, {
        headers: {
  ...
  const deleteInputLastImage = async (imageName:string) => {
    axios 
      .post(`${MainURL}/tourschedulebox/deletelocationimage`, {
  ...
  const reviseLocation = async () => {
    ...
    axios 
      .post(`${MainURL}/tourschedulebox/reviselocation`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
        },
        params: getParams,
      ...
      <section>
        ...
        <div className="coverbox">
          <div className="coverrow hole">
            ...
            <div className='checkInputCover'>
              <SelectBox text='가이드투어'/>
              <SelectBox text='입장권'/>
              <SelectBox text='탑승권'/>
              <SelectBox text='액티비티'/>
              <SelectBox text='공연/경기'/>
              <SelectBox text='식사/카페/바/클럽'/>
              <SelectBox text='미팅샌딩'/>
              <SelectBox text='렌트카'/>
            </div>
          </div>
