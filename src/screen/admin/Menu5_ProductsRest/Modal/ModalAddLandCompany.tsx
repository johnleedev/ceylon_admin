          ...
          <div className="coverrow hole">
            ...
            <div style={{width:'90%', textAlign:'center'}}>
              ...
              <div style={{display:'flex', alignItems:'center'}}>
                ...
                <div style={{width:'20%', display:'flex', alignItems:'center', justifyContent:'center'}}>
                  <DateBoxNum width='120px' subWidth='120px' right={5} date={issue.issueTitle}
                      setSelectDate={(e:any)=>{ 
                        const copy = {...issue};
                        copy.issueTitle = e;
                        setIssue(copy);
          ...
          <div className="coverrow hole">
            ...
            <div style={{width:'90%', textAlign:'center'}}>
              ...
              <div style={{display:'flex', alignItems:'center'}}>
                ...
                <div style={{width:'30%', display:'flex', alignItems:'center', justifyContent:'center'}}>
                  <DateBoxNum width='120px' subWidth='120px' right={5} date={benefits.periodStart}
                      setSelectDate={(e:any)=>{ 
                        const copy = {...benefits};
                        copy.periodStart = e;
                        copy.periodEnd = e;
                    ...
                    <DateBoxNum width='120px' subWidth='120px' right={5} date={benefits.periodEnd}
                      setSelectDate={(e:any)=>{ 
                        const copy = {...benefits};
                        copy.periodEnd = e;
                        setBenefits(copy);
                ...
                <div style={{width:'20%', display:'flex', alignItems:'center', justifyContent:'center'}}>
                  <DateBoxNum width='120px' subWidth='120px' right={5} date={benefits.date}
                      setSelectDate={(e:any)=>{ 
                        const copy = {...benefits};
                        copy.date = e;
                        setBenefits(copy);
