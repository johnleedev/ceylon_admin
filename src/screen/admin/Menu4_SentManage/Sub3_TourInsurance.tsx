...
export default function Sub3_TourInsurance (props:any) {
			...
			<div className="seachlist">
				...
				<div className="main-list-cover">
					<div className="TitleList">
						...
						<TitleList width='8%' text='여행지'/>
						<TitleList width='10%' text='여행기간'/>
						<TitleList width='7%' text='보험사'/>
						<TitleList width='7%' text='발송일'/>
						...
						viewList.map((item:any, index:any)=>{
							return (
								<div key={index} className="rowbox">
									...
									<TextBox width='8%' text={item.phone} />
									<TextBox width='8%' text={item.tourLocation} />
									<TextBox width='8%' text={item.tourPeriod} />
