        ...
        <div className="coverbox">
          <div className="coverrow hole" style={{minHeight:'40px'}} >
            ...
            <div style={{width:'20%', display:'flex', alignItems:'center', justifyContent:'center'}}>
              <DateBoxNum width='120px' subWidth='120px' right={5} date={seasonCost.periodStart}
                setSelectDate={(e:any)=>{ 
              ...
              <DateBoxNum width='120px' subWidth='120px' right={5} date={seasonCost.periodEnd}
                setSelectDate={(e:any)=>{ 
                  const inputs = {...seasonCost};
                  inputs.periodEnd = e;
                  setSeasonCost(inputs);
      ...
      <section>
        ...
        <div className="coverbox">
          <div className="coverrow hole">
            ...
            <DateBoxNum width='120px' subWidth='120px' right={5} date={periodData[0].periodStart}
              setSelectDate={(e:any)=>{ 
            ...
            />
            <p style={{marginLeft:'5px'}}>~</p>
            <DateBoxNum width='120px' subWidth='120px' right={5} date={periodData[0].periodEnd}
              setSelectDate={(e:any)=>{ 
                const inputs = {...periodData};
                inputs[0].periodEnd = e;
                inputs[0].earlyPeriod = '';
        ...
        <div className="coverbox">
          <div className="coverrow hole">
            ...
            <DateBoxNum width='120px' subWidth='120px' right={5} date={periodData[1].periodStart}
              setSelectDate={(e:any)=>{ 
                const inputs = {...periodData};
            ...
            />
            <p style={{marginLeft:'5px'}}>~</p>
            <DateBoxNum width='120px' subWidth='120px' right={5} date={periodData[1].periodEnd}
              setSelectDate={(e:any)=>{ 
                const inputs = {...periodData};
                inputs[1].periodEnd = e;
                setPeriodData(inputs)
