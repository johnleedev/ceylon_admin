...
export default function Sub1_ReserveList (props:any) {
	...
	const example = [
		{ no: 1, reserveDate: '2024-04-24', startDate: '2024-04-24', name1 : '김실론어', name2 : '이박투어',  phone1 : '010-1234-5678', phone2 : '010-1234-5678',
			tourProduct : 'OZ 인천 하와이 5박 7일', tourCost : 7500000, landCompany: '퍼시픽', 
			reservePath : '웨딩쿨 서주희', state : '계약금입금', charger : '김철수'},
			...
			<div className="seachlist">
				...
				<div className="main-list-cover">
					<div className="titlebox">
						...
						<TitleBox width={180} text='예약일/출발일'/>
						...
						example.map((item:any, index:any)=>{
							return (
								<div key={index}
									className="rowbox"
									onClick={()=>{
										navigate('/reserve/reservedetail', {state : item});
									}}
								>
									<TextBox width={50} text={item.no} fontSize={15}/>
									<TextBox width={180} text={item.reserveDate} text2={item.startDate} fontSize={15}/>
