  ...
  return (
    <div className='DocumentReserve'>
      ...
      <div className="d-cover">
        ...
        <div className="d-textrow">
          ...
          <div style={{display:'flex', flexDirection:'column', flex:1}}>
            <div style={{display:'flex', alignItems:'center'}}>
              <TextBox text='출발' />
              <D_Input width={100} value={''} func={()=>{}}/>
              <D_Input width={200} value={''} func={()=>{}}/>
            </div>
        ...
        <div className="d-textrow">
          <D_Title text='입금계좌' />
          <TextBox text='하나은행 103-910048-51204  (주)실론투어' />
        </div>
        <div className="d-textrow">
          <D_Title text='결제일' />
          <div style={{flex:1}}>
            <div style={{display:'flex'}}>
              <TextBox text='계약금' width={60}/>
              <D_Input width={150} value={''} func={()=>{}}/>
              <TextBox text='원'/>
              <D_Input width={120} value={''} func={()=>{}}/>
              <D_Input width={150} value={''} func={()=>{}}/>
            </div>
            <div style={{display:'flex'}}>
              <TextBox text='항공료' width={60}/>
              <D_Input width={150} value={''} func={()=>{}}/>
              <TextBox text='원'/>
              <D_Input width={120} value={''} func={()=>{}}/>
              <D_Input width={150} value={''} func={()=>{}}/>
